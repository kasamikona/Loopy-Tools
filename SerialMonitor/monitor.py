...
cmd_map = {
	"read":       (cmd_low.run_cmd_read_nbit,   ["8","16","32"], "Read values with 8/16/32-bit access"),
	"write":      (cmd_low.run_cmd_write_nbit,  ["8","16","32"], "Write values with 8/16/32-bit access"),
	"dump":       (cmd_low.run_cmd_dump_nbit,   ["8","16","32"], "Save values to a file with 8/16/32-bit access"),
	"burst":      (cmd_low.run_cmd_burst_nbit,  ["8","16","32"], "Load values from a file with 8/16/32-bit access"),
	"hist":       (cmd_low.run_cmd_hist_nbit,   ["8","16","32"], "Read a value repeatedly and log a histogram (slow)"),
	"call":       (cmd_low.run_cmd_call,        None,            "Call a known function with given parameters"),
	"labels":     (cmd_meta.run_cmd_labels,     None,            "List memory address labels"),
	"listfuncs":  (cmd_meta.run_cmd_listfuncs,  None,            "List known callable functions"),
	...
	"screencap":  (cmd_high.run_cmd_screencap,  None,            "Create a screen capture (slow)"),
	"movemotor":  (cmd_high.run_cmd_movemotor,  None,            "Directly control the printer motor (UNSAFE)"),
