...
FUNC_LABELS = { # name -> (addr, num_args, ret_type, long_run)
	...
	"bios_printParts":            (0x06D4, 8, DataType.BYTE, True),
	"bios_printDirect":           (0x0FD6, 7, DataType.BYTE, True),
	"bios_print15bpp":            (0x101C, 2, DataType.BYTE, True),
	"bios_print8bpp":             (0x1064, 3, DataType.BYTE, True),
	"bios_getSealType":           (0x115C, 0, DataType.BYTE, False),
	"bios_measurePrintTemp":      (0x13B0, 0, DataType.BYTE, False),
	"bios_colorInverseGray":      (0x2D68, 1, DataType.BYTE, False),
	"bios_valueBlendQuarter":     (0x2DC6, 2, DataType.BYTE, False),
	"bios_colorBlendQuarter":     (0x2DE0, 2, DataType.BYTE, False),
	"bios_mulS16":                (0x2E68, 2, DataType.BYTE, False),
	"bios_mulU16":                (0x2E72, 2, DataType.BYTE, False),
	"bios_divU16":                (0x2E7C, 2, DataType.BYTE, False),
	"bios_divS16":                (0x2EA6, 2, DataType.BYTE, False),
	"bios_divS32":                (0x2EDE, 2, DataType.BYTE, False),
	...
	"_bios_movePrinter":         (0x1B76, 2, DataType.BYTE, True),
